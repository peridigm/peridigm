...
test_dir = "RKPM_UserDefinedKernel/RKPM_UserDefinedKernel_np4"
base_name = "RKPM"
subtest_name = "UserDefinedKernel"
...
if __name__ == "__main__":
    ...
    # run Peridigm
    command = ["mpiexec", "-np", "4", "../../../../src/Peridigm", "../"+base_name+"_"+subtest_name+".xml"]

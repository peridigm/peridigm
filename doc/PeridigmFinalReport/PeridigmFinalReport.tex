...
% agile components:  effort to align development efforts, enable rapid code development, embed UQ, optimization.  Unifying.  ModelEvaluator.  Interoperibility.
%
% Created SimpleODE MiniApplication (template), Peridigm.  Albany of course exists as well.
%
% Practical experience gained:
%  - if you fit the contraints, agile components work well.  if you don't, you have work to do.
%  - specific non-fits for Peridigm are adaptivity, statelessness, need for fine control of time integration (flow control)
%  - minor gripes as well, such as Map versus Block_Map
%
% took a different route due to need for non-fits to fit
%
% used lots of best practices from Trilinos
%
% recommendations.  Documentation, graceful handling of model state, minor gripes, flow control
%
% informed direction with regard to adaptivity and state
